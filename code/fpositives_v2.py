...
with codecs.open("../data/f_positive_clean_1.txt", 'r', encoding='unicode_escape') as file:
    query_1 = file.read()
with codecs.open("../data/f_positive_clean_2.txt", 'r', encoding='unicode_escape') as file:
    query_2 = file.read()
with codecs.open("../data/f_positive_clean_3.txt", 'r', encoding='unicode_escape') as file:
    query_3 = file.read()
...
for key in unique_keys[34060:]:              ## loop over gvkey list
    count += 1
...
fpositive_df.to_csv("../data/fpositive_v2.csv")

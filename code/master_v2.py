...
web_url = "https://hooks.slack.com/services/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"

@slack_sender(webhook_url=web_url, channel="masterpy")
##Load in keys
def main():
    ...
    master_df.to_csv("../data/master_v3_v2.csv")
    print("Complete.")
    return("Entries: " + str(len(master_df)))

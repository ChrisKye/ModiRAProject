...
*Read the data (provided as part of the replication package)
import excel "C:\Users\gokce\Desktop\referee report\update paper\veri\GSSrawdata.xls", firstrow
...
drop month day year
sort datedaily 
drop if datedaily>=mdy(1,1,2019)
save datsurprisewithpath.dta, replace
...
*As a robustness check, we run regressions with Miranda-Agrippino and Ricco (2021) residuals.
*See do1policysurprises_infoeffect. 
/*
clear
use "C:\Users\gokce\Desktop\referee report\update paper\veri\mardata.dta", clear
